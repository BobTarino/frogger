...
class Particle{ // holds blueprint for patricle
    constructor(x, y){ // x and y coordinates want to be passed underneath frog
        ...
        this.opacity = 0.5; // for fading particles
...
function handleParticles(){
    ...
    if (((keys[37] || keys[38] || keys[39] || keys [40])) && frogger.y > 100 && particlesArray.length < maxParticles + 10){ // if frog is moving when keys are pressed && frogger is on road && and no more than 200 particles in array for performance reasons
